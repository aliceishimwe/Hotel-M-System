    ...
    <section id="features">
     ...
     {?>
		<tr>
			...
			<td><?php echo $row['chips'],",", $row['pizza']," ,",$row['beef'],", ",$row['drinks'];  ?></td>
			<td><a href="delete.php?id=<?php echo $row['id'];?>" style="text-decoration: none;">Delete</a>
          <a href="update.php?id=<?php echo $row['id'];?>" style="text-decoration: none;"> Update</a>
			</td>
		</tr>
		<?php
		}?>
